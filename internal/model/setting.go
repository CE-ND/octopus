...
const (
	...
	SettingKeyRelayLogFullContentEnabled       SettingKey = "relay_log_full_content_enabled"       // 是否保存完整请求/响应正文（仅用于短期调试）
...
func DefaultSettings() []Setting {
	return []Setting{
		...
		{Key: SettingKeyRelayLogFullContentEnabled, Value: "false"},   // 默认仅保留有大小上限的正文预览
...
func (s *Setting) Validate() error {
	...
	case SettingKeySSEHeartbeatInterval, SettingKeySSEPreStreamHeartbeatDelay:
		...
		return nil
	case SettingKeyRelayLogKeepEnabled, SettingKeyRelayLogFullContentEnabled, SettingKeyDumpBadResponsesEnabled, SettingKeyResponsesWSEnabled, SettingKeyGroupHealthEnabled, SettingKeyStatsSiteModelBackfilled, SettingKeyOutlierRetireEnabled:
